    ...
    <section className={`card-widget card-info profile-card ${variantClass}`} style={style}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .profile-card::before {
          ...
          animation: bg-evolution 15s ease infinite !important;
          z-index: -1;
        }
        .author-info-avatar {
          position: absolute;
        ...
        .avatar-halo {
          ...
          height: 140px;
          transform: translate(-50%, -50%);
          background: conic-gradient(from 0deg, transparent, rgba(157, 80, 255, 0.4), transparent, rgba(53, 139, 255, 0.4), transparent);
          border-radius: 50%;
