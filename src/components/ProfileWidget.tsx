      ...
      <div className="card-content">
        ...
        <div className="author-info__description">
          <div className="author-info__description-text">
            这里分享系统重构、Zero Trust 架构与数字边境的探索指南。我致力于在碳基生物学与硅基代码的交界处，为你提炼极客向的折腾日记与实用技巧。
          </div>
        </div>
        ...
        <div className="author-info__bottom-group">
          ...
          <div className="card-info-social-icons" aria-label="作者链接">
            ...
            <a className="social-icon" href="https://threads.net/@techshijian" target="_blank" rel="noreferrer" title="Threads">
              <svg viewBox="0 0 24 24" width="18" height="18"><path d="M12 24c-1.336 0-2.671-.143-4-.429a11.96 11.96 0 0 1-5.187-2.4 11.96 11.96 0 0 1-4.086-4.945c-.482-1.171-.727-2.42-.727-3.714V11.23a13.313 13.313 0 0 1 1.2-5.485 11.832 11.832 0 0 1 3.258-4.286 11.832 11.832 0 0 1 4.714-2.228C8.4 1.143 9.771 1 11.23 1H12.77c1.458 0 2.829.143 4.057.429a11.832 11.832 0 0 1 4.714 2.228 11.832 11.832 0 0 1 3.258 4.286 13.313 13.313 0 0 1 1.2 5.485v1.286c0 1.294-.245 2.543-.727 3.714a11.96 11.96 0 0 1-4.086 4.945 11.96 11.96 0 0 1-5.187 2.4c-1.329.286-2.664.429-4 .429h-.001zM11.23 21.257c.758.106 1.516.143 2.285.143s1.527-.037 2.285-.143c1.029-.143 2.057-.457 3-.886a9.58 9.58 0 0 0 3.343-2.228 9.58 9.58 0 0 0 2.457-3.6c.4-.971.6-2.029.6-3.114V11.23a10.835 10.835 0 0 0-1.029-4.543 9.544 9.544 0 0 0-2.657-3.514 9.544 9.544 0 0 0-3.857-1.8c-.943-.2-1.943-.314-2.914-.314h-1.542c-.971 0-1.971.114-2.914.314a9.544 9.544 0 0 0-3.857 1.8 9.544 9.544 0 0 0-2.657 3.514 10.835 10.835 0 0 0-1.029 4.543v1.286c0 1.085.2 2.143.6 3.114a9.58 9.58 0 0 0 2.457 3.6 9.58 9.58 0 0 0 3.343 2.228c.943.429 1.971.743 3 .886.758.106 1.516.143 2.285.143zM12 18c-3.143 0-5.714-2.571-5.714-5.714s2.571-5.714 5.714-5.714 5.714 2.571 5.714 5.714S15.143 18 12 18zM12 15c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3z" fill="currentColor"/></svg>
            </a>
          </div>
        </div>
      </div>
