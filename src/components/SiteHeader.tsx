    ...
    <header id="page-header" className={`site-header not-top-img nav-fixed nav-visible`}>
      <nav id="nav" aria-label="主导航">
        <div id="nav-group">
          ...
          <div id="nav-right">
            {/* 架构重构：双轨制导航图标系统 (Dual-Track Icon System) */}
            {/* Set B: 安知鱼高保真套餐 (Anzhiyu High-Fi Set - 默认开启) */}
            <div className="nav-icon-set-highfi flex items-center">
              {isAccountEnabled && (
                <div className="nav-button" id="nav-account">
                  ...
                  >
                    <User size={18} strokeWidth={3} aria-hidden="true" />
                  </a>
                </div>
              )}
              ...
              {showNotificationTrigger && (
                <div className="nav-button" id="nav-notification">
                  <a 
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      notificationOpen ? closeNotificationPanel() : openNotificationPanel();
                    }}
              ...
              <div className="nav-button" id="nav-theme-toggle">
                <a className="site-page" href="#" data-tooltip="切换主题" onClick={(e) => {
                  ...
                  {theme === 'dark' ? (
                    <SunMedium size={18} strokeWidth={3} aria-hidden="true" />
                  ) : (
                    <MoonStar size={18} strokeWidth={3} aria-hidden="true" />
                  )}
                </a>
              </div>
              ...
              <div className="nav-button" id="randomPost_button">
                <a className="site-page" href="#" data-tooltip="随机文章" onClick={(e) => {
                  ...
                  <Dices size={18} strokeWidth={3} aria-hidden="true" />
                </a>
              </div>

              {showCenterConsoleTrigger && (
                <div className="nav-button p-0" id="center-console-container">
                  {consoleIcon}
                </div>
              )}
            </div>

            {/* Set A: 经典线性套餐 (Classic Line Set - 默认隐藏/备份) */}
            <div className="nav-icon-set-classic hidden flex items-center opacity-0 pointer-events-none absolute">
              {isAccountEnabled && (
              ...
              {/* 旧版三横线中控台 */}
              <div className="anzhiyu-matrix-icon flex flex-col justify-between w-[16px] h-[12px]">
            ...
            <div id="toggle-menu" className={menuOpen ? 'is-open' : ''}>
              ...
              >
                <Menu size={18} strokeWidth={3} aria-hidden="true" />
              </a>
            </div>
            ...
            <div className={`nav-button back-to-top-btn ${progress === 0 ? 'at-top' : ''}`} id="nav-totop">
              ...
              >
                ...
                <ArrowUp className="arrow-icon" size={18} strokeWidth={3} aria-hidden="true" />
              </a>
            </div>
          </div>
        </div>
