...
const COUNTRY_CURRENCY: Record<string, CurrencyConfig> = {
  ...
  KW: { code: 'kwd', symbol: 'KWD', amounts: [1, 2, 3, 5, 7, 10],                 min: 1,   max: 40    },
  BH: { code: 'bhd', symbol: 'BHD', amounts: [1, 2, 3, 5, 7, 10],                 min: 1,   max: 48    },
  OM: { code: 'omr', symbol: 'OMR', amounts: [1, 2, 3, 5, 7, 10],                 min: 1,   max: 49    },
...
const I18N = {
  ...
  'en': {
    ...
    minError: (min: string) => `Minimum amount is ${min}`,
  ...
  'fr': {
    ...
    minError: (min: string) => `Le montant minimum est ${min}`,
  ...
  'es': {
    ...
    minError: (min: string) => `El monto mínimo es ${min}`,
  ...
  'de': {
    ...
    minError: (min: string) => `Mindestbetrag ist ${min}`,
