...
description: "仿照 LinuxDo 社区风格，全面盘点 EpoCanvas 博客信任阶梯（TL.0 ~ TL.99）、8 级核心称号、15+ 枚成就徽章的判定算法与解锁秘籍。极客玩法、防踩坑指北与名片排版全揭秘。"
pubDate: 2026-09-12
author: "shijianus"
category: "社区指南"
group: "官方规范"
tags: ["社区指南", "LinuxDo", "等级阶梯", "徽章系统", "EpoCanvas", "Astro"]
...
今天，这篇完全参照 **LinuxDo 社区规范与极客美学** 的官方指南，将向大家彻底开源揭秘 EpoCanvas 博客现行的 **信任阶梯系统（Trust Levels）**、**8 大核心称号** 与 **15+ 枚专属成就徽章** 的判定底层算法与实操升级路径！
...
EpoCanvas 博客的信任阶梯（Trust Level，简称 TL）深度汲取了 Discourse 与 LinuxDo 的社区治理哲学。我们坚信：**“水贴不如精读，浮躁不如沉淀”**。全站划分为 8 个原生信任阶梯，每一个等级都严格由代码自动化审计判定：
...
独乐乐不如众乐乐。EpoCanvas 原生自研的评论互动系统，支持 LinuxDo 风格的多模态交互、Boost 打气与就地回复树：
...
> [!tip]
> **佬友黑话**：LinuxDo 佬友最核心的精髓就是“能用表情表达的情感，绝不多打废话”。遇到击中痛点的评论，毫不犹豫送上一枚 🔥 吧！
