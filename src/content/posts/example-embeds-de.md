---
title: "Beispiel: Rich Media Einbettungen, Post-Formate und Chat-Dialoge"
description: "Umfassende Demonstration von WordPress-ähnlichen Post-Formaten, Video-/Audio-Vinyl-Karten, Lesezeichen-Karten und Chat-Blasen-Dialogen."
pubDate: 2026-08-28
draft: false
toc: true
tags: ["Beispiel", "Demonstration", "Einbettungen", "Post-Formate"]
category: "Beispiel"
...
Dieses Beispiel dient der Demonstration und dem Test von **Rich Media Einbettungen (Embeds), WordPress Post-Formaten und Zwei-Personen-Dialogen (Chat-Dialoge)** im Blog-Beitragstext.

---

## 1. Notizen und Statusmeldungen (Aside & Status)

### 1.1 Aside Notizkarte

<div class="article-aside">
  <p><strong>💡 Notiz</strong>: Der wahre Wert statischer Websites liegt nicht im Zurschaustellen von Fähigkeiten, sondern in der Bereitstellung eines extrem schnellen, wartungsfreien und reinen Leseerlebnisses.</p>
</div>
...
<div class="article-status">
  ...
  <p class="article-status__content">
    Heute habe ich endlich die vollständige Format-Erweiterung und visuelle Neugestaltung der Inhaltsspalte abgeschlossen! Von KaTeX, Mermaid bis hin zu interaktiven Dropdowns und Vinyl-Karten – statische Bereitstellung ist einfach fantastisch! 🚀✨
  </p>
</div>
...
Beim Abspielen des Audios wird das Plattencover automatisch eine stufenlose, sanfte Rotationsanimation auslösen:

<div class="article-audio-card">
  <div class="audio-card__cover">
    <img src="/media/shijianus/workbench.jpg" alt="Plattencover" />
  </div>
  <div class="audio-card__info">
    <div class="audio-card__title">Sternenwanderung (Ambient Focus)</div>
    <div class="audio-card__author">shijianus · Originaler Deep Focus White Noise</div>
...
## 3. Lesezeichenkarte für externe Links
...
<a class="article-bookmark" href="https://github.com/anzhiyu-c/hexo-theme-anzhiyu" target="_blank" rel="noopener">
  <div class="article-bookmark__content">
    ...
    <p class="article-bookmark__desc">AnZhiYu ist ein hochgelobtes Geek-Blog-Theme für die Hexo-Plattform, das mit seinen hervorragenden Mikroanimationen und seinem Informationsdichte-Design zum Industriestandard geworden ist.</p>
...
## 4. Animierter Dialogfluss mit Chat-Blasen (Organic Animated Dialogue Stream)

Konfigurieren Sie `data-animate="true"`, um realistische Tipp- und Sendeanimationen, dynamische Avatare (`footer_mini_logo__media`) und spezielle Hinweistöne zu aktivieren, die beim ersten Scrollen in den Ansichtsbereich ausgelöst werden:
...
<div class="article-chat" data-animate="true" data-sound="true">
  ...
  <div class="chat-message chat-right">
    ...
    <div class="chat-body">
      ...
      <div class="chat-bubble">
        Überhaupt nicht! Da <code>remark-math</code> und <code>rehype-katex</code> die Formeln bereits zur Build-Zeit (Build-time) in reine HTML/MathML-Strings kompilieren, gibt es auf der Browserseite <strong>keine JS-Laufzeitbelastung</strong>; und Mermaid-Diagramme werden ebenfalls dynamisch und asynchron als ESM-Module bei Bedarf geladen, was den ersten Bildschirm extrem schnell macht! ⚡
      </div>
    </div>
  </div>
  ...
  <div class="chat-message chat-left">
    ...
    <div class="chat-body">
      ...
      <div class="chat-bubble">
        Das ist großartig! Die Tippanimation, die sich an die Länge der Nachricht anpasst, und der dynamische Avatar-Effekt sind fantastisch! 🎉
      </div>
    </div>
  </div>
</div>
...
## 5. Interaktiver Einheiten- und Währungsumrechner mit hoher Präzision
