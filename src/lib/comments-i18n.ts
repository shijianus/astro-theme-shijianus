...
export const COMMENTS_I18N: Record<LocaleVariant, CommentTranslations> = {
  ...
  en: {
    ...
    loginAsGuest: 'Guest (Click to Login)',
    ...
    modalPollTypeRegular: 'Single Choice (Regular)',
    ...
    imageTabGuide: '📋 Paste & Drag Guide',
    imageTabUrl: '🔗 External Image URL',
  ...
  fr: {
    ...
    loginAsGuest: 'Invité (Cliquer pour se connecter)',
    ...
    modalPollTypeRegular: 'Choix unique (Régulier)',
    ...
    imageTabUpload: 'Téléversement local',
    imageTabGuide: '📋 Guide Copier-Coller & Glisser',
    imageTabUrl: '🔗 Lien d’image externe',
  ...
  es: {
    ...
    loginAsGuest: 'Visitante (Clic para iniciar sesión)',
    ...
    modalPollTypeRegular: 'Opción única (Regular)',
    ...
    imageTabUpload: 'Subida local',
    imageTabGuide: '📋 Guía de pegar y arrastrar',
    imageTabUrl: '🔗 Enlace de imagen externa',
  ...
  de: {
    ...
    loginAsGuest: 'Gast (Klicken zum Anmelden)',
    ...
    modalPollTypeRegular: 'Einzelauswahl (Regulär)',
    ...
    imageTabGuide: '📋 Anleitung zu Einfügen & Drag-and-Drop',
