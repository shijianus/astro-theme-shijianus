...
export const LOCALE_METADATA: Record<LocaleVariant, LocaleMetadata> = {
  'zh-CN': {
    ...
    'nav.submenuAria': '子页面',
 code: 'zh-CN', nativeName: '简体中文', englishName: 'Simplified Chinese', badge: '简', flag: '🇨🇳' },
  'zh-Hant': {
    // Extended System & Support i18n
    ...
    'nav.submenuAria': '子頁面',
 code: 'zh-Hant', nativeName: '繁體中文', englishName: 'Traditional Chinese', badge: '繁', flag: '🇭🇰' },
