...
const postsCollection = defineCollection({
  ...
  schema: z.object({
    ...
    /**
     * Unified i18n Identifier:
     * Connects different translations (user-written or AI-generated) of the same article.
     * Defaults to the base slug of the post if omitted.
     */
    i18nKey: z.string().optional(),

    /** Language code of the article (e.g. 'zh-CN', 'en', 'fr', 'es', 'de', 'zh-Hant') */
    lang: z.string().default('zh-CN').optional(),

    /** Flag indicating whether this translation was automatically generated by AI at build time */
    isAiGenerated: z.boolean().default(false).optional(),

    /** Source language code this translation was generated from */
    aiTranslatedFrom: z.string().optional(),
  }),
});
