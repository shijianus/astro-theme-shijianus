    ...
    primary: [
      {
        ...
        icon: 'archive',
        children: [
          { label: '全部文章', href: '/archives/', icon: 'archive' },
          { label: '分类浏览', href: '/categories/', icon: 'category' },
      ...
      },
      {
        ...
        icon: 'link',
        children: [
          { label: '友人帐', href: '/friends/', icon: 'link' },
          { label: '朋友圈', href: '/friends/#moments', icon: 'rss' },
          { label: '留言板', href: '/friends/#message-board', icon: 'message' },
        ],
      },
      {
        label: '实验',
        ...
        icon: 'book',
        children: [
          { label: '实验室', href: '/lab/', icon: 'book' },
          { label: '音乐服务', href: '/lab/#music', icon: 'rss' },
          { label: '影视服务', href: '/lab/#movie', icon: 'home' },
        ],
      },
      {
        label: '关于',
        ...
        icon: 'about',
        children: [
          { label: '关于作者', href: '/about/', icon: 'about' },
          { label: '站点状态', href: '/status/', icon: 'rss' },
          { label: '主题路线', href: '/roadmap/', icon: 'book' },
        ],
      },
