...
export const siteConfig = {
  ...
  navigation: {
    primary: [
      { label: '首页 | Home', href: '/', description: '回到首页', icon: 'home' },
      {
        label: '阅览 | Posts',
        href: '/archives/',
        description: '部落格的主体内容',
        icon: 'archive',
        children: [
          { label: '归档 | Archives', href: '/archives/', description: '时间线总览', icon: 'archive' },
          { label: '分类 | Categories', href: '/categories/', description: '分类总览与入口', icon: 'category' },
          { label: '标签 | Tags', href: '/tags/', description: '标签索引与聚合入口', icon: 'tags' },
        ],
      },
      {
        label: '相识 | Hub',
        ...
        icon: 'link',
        children: [
          { label: '友链 | Friends', href: '/friends/', description: '交友平台和朋友圈', icon: 'link' },
          { label: '留言 | Guestbook', href: '/comments/', description: '留言板', icon: 'message' },
          { label: '生活 | Life', href: '/life/', description: '生活分享', icon: 'home' },
        ],
      },
      {
        label: '应用 | Apps',
        ...
        icon: 'category',
        children: [
          { label: '音乐 | Music', href: '/music/', description: '音乐服务', icon: 'book' },
          { label: '影视 | Movies', href: '/movies/', description: '影视服务', icon: 'rss' },
          { label: '工具 | Tools', href: '/tools/', description: '其他工具', icon: 'category' },
        ],
      },
      {
        label: '印记 | About',
        ...
        icon: 'about',
        children: [
          { label: '关于 | Profile', href: '/about/', description: '关于作者', icon: 'about' },
          { label: '路线 | Roadmap', href: '/roadmap/', description: '主题路线', icon: 'book' },
          { label: '状态 | Status', href: '/status/', description: '站点状态', icon: 'rss' },
        ],
      },
