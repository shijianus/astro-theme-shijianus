...
export const siteConfig = {
  ...
  post: {
    ...
    outdateNotice: {
      enabled: true,
      defaultDays: 365,
      template: '距离上次更新已经过去了 {days} 天，文章的内容可能已经过时。',
    },
    ai: {
      gptName: 'Shijianus',
      introTemplates: [
      ...
      fallbackNotice: '当前暂由本地智能引擎生成内容提要与阅读建议，可点击下方按钮获取更多推荐。',
    },
    tools: {
      aboutTitle: '关于说明',
      modeLabel: '运营模式与责任',
