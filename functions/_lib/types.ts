...
export type AppEnv = {
  ...
  AI_SUMMARY_LEVEL?: string;
  AI_SUMMARY_FIXED_MODEL?: string;
  AI_SUMMARY_MODEL_POOL?: string;
  AI_SUMMARY_CUSTOM_SYSTEM_PROMPT?: string;
  AI_SUMMARY_CUSTOM_USER_PROMPT?: string;
  SUPPORT_USDT_ADDRESS?: string;
  SUPPORT_USDT_ARBITRUM_ADDRESS?: string;
  PUBLIC_USDT_ARBITRUM_ADDRESS?: string;
